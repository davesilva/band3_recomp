...
extern "C" REX_FUNC(CamShot__Shake) {
	...
	// lfs f30,3448(r11)
	ctx.fpscr.disableFlushMode();
	temp.u32 = REX_LOAD_U32(ctx.r11.u32 + 3448);
	...
	// lbz r11,29846(r11)
	ctx.r11.u64 = REX_LOAD_U8(ctx.r11.u32 + 29846);
	// cmplwi r11,0
	...
	ctx.r11.s64 = -2113601536;
	// lfs f12,332(r31)
	temp.u32 = REX_LOAD_U32(ctx.r31.u32 + 332);
	ctx.f12.f64 = double(temp.f32);
	// fmr f1,f29
...
loc_824BDCFC:
	...
	// lfs f12,-4696(r11)
	temp.u32 = REX_LOAD_U32(ctx.r11.u32 + -4696);
	ctx.f12.f64 = double(temp.f32);
	// fsubs f0,f0,f31
...
loc_824BDDB0:
	...
	// lfs f11,316(r31)
	temp.u32 = REX_LOAD_U32(ctx.r31.u32 + 316);
	ctx.f11.f64 = double(temp.f32);
	// lwz r8,388(r31)
...
loc_824BDFA4:
	// lwz r9,296(r31)
	ctx.r9.u64 = REX_LOAD_U32(ctx.r31.u32 + 296);
	// addi r11,r31,296
